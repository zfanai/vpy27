...
class Celery(object):
    ...
    def __init__(self, main=None, loader=None, backend=None,
        ...
        debug.trace('celery', 'Celery.__init__:')
        ...
        def inner_create_task_cls(shared=True, filter=None, **opts):
            ...
            def _create_task_cls(fun):
                ...
                if self.accept_magic_kwargs:  # compat mode
                    debug.trace('celery', 'inner_create_task_cls,1')
                ...
                if self.finalized or opts.get('_force_evaluate'):
                    debug.trace('celery', 'inner_create_task_cls,2')
                    ret = self._task_from_fun(fun, **opts)
                else:
                    debug.trace('celery', 'inner_create_task_cls,3')
