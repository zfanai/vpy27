    ...
    * if :meth:`switch`/:meth:`throw` is called before the receiver calls :meth:`get`, then :class:`Waiter`
    ...
    def get(self):
        ...
        if self._exception is not _NONE:
            ...
            try:
                # switch函数开始执行函数体, 或者说是Greenlet对象, Greenlet是微线程对象。
                # hub是一个总控中心。
                #print 'zf,Waiter,get'
...
class _MultipleWaiter(Waiter):
    ...
    def get(self):
        if not self._values:
            #print 'zf,_MultipleWaiter,get,1'
            Waiter.get(self)
            #print 'zf,_MultipleWaiter,get,2'
            Waiter.clear(self)
